...
<section class="mainscreen">
    ...
    <div class="container mainscreen__container _anim-item">
        <h1 class="mainscreen__title title">Уменьшение платежа<br>по НДС от 1.2% без предоплаты </h1>
        <h3 class="mainscreen__subtitle subtitle">Бесплатная консультация по списанию кредиторской<br>задолженности и складских остатков</h3>
        <a href="" data-goto=".request"  class="mainscreen__btn btn">Получить консультацию</a>
    </div>
</section>
<!-- /mainscreen -->
...
<section class="service">
    <div class="container service__container _anim-item">
        <div class="service__top">
            <h2 class="service__title title">Консалтинговое бюро<br>«Профи»:</h2>

            <div class="service__btns" data-da=".service__container,767,last">
                <h3 class="service__subtitle">Нужна консультация?</h3>
                <a href="" data-goto=".request" class="service__btn btn">Свяжитесь с нами</a>
            </div>
        </div>
        <div class="service__row">
            <div class="service__col">
                <div class="service__icon _icon-graph"></div>
                <p class="service__text">Законно уменьшит платежи по НДС, налогу на прибыль. При необходимости готовы предоставить Вам индивидуальную схему работы под Ваши задачи</p>
            </div>

            <div class="service__col">
                <div class="service__icon _icon-file"></div>
                <p class="service__text">Закроет Ваши авансовые отчеты</p>
            </div>

            <div class="service__col">
                <div class="service__icon _icon-tractor"></div>
                <p class="service__text">Поможет безопасно и эффективно оплатить утилизационный сбор на спецтехнику и самоходные машины</p>
            </div>
        </div>
    </div>
</section>
...
<section class="stages">
    <div class="container stages__container _anim-item">
        <h2 class="stages__title title">Этапы работы с нами:</h2>
        <ul class="stages__list">
            <li><span>Заявка</span></li>
            <li class="_icon-arrow"><span>Подбор контрагентов</span></li>
            <li class="_icon-arrow"><span>Подтверждение о сдаче отчетности</span></li>
            <li class="_icon-arrow"><span>Оплата</span></li>
        </ul>
    </div>
</section>
<!-- /stages -->
...
<section class="special">
    <div class="container special__container _anim-item">
        <h2 class="special__title title">
            При необходимости подберем<br>индивидуальный вариант работы
        </h2>
    </div>
</section>
<!-- /special -->
...
<!-- about -->
<section class="about">
    <div class="container about__container _anim-item">
        <h2 class="about__title title">Кому мы окажемся полезны:</h2>
        <div class="about__slider ">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <p class="about__text">
                            Крупный/средний/малый бизнес в сферах строительства, машиностроение, продажа запасных частей, техники, сервисные компании, оптовая продажа металла, металлообработка и прочее.
                        </p>
                    </div>

                    <div class="swiper-slide">
                        <p class="about__text">
                            Площадки, которые готовы отдать услугу на аутсорсинг (это выгодно, т.к. вам нет необходимости тратить свои ресурсы и время на построение цепочек)
                        </p>
                    </div>

                    <div class="swiper-slide">
                        <p class="about__text">
                            Плательщики утилизационного сбора на спецтехнику и самоходные машины
                        </p>
                    </div>

                    <div class="swiper-slide">
                        <p class="about__text">
                            Реселлеры – агенты, которые готовы развиваться на партнерских отношениях
                        </p>
                    </div>
                </div>
            </div>
...
<!-- no-work -->
<section class="no-work">
    <div class="container no-work__container _anim-item">
        <h2 class="no-work__title title">С кем мы не работаем:</h2>
        <div class="no-work__row">
            <div class="no-work__col">
                <span>1</span>
                <p class="no-work__text">
                    Бизнес с государственным участием
                </p>
            </div>
            ...
            <div class="no-work__col">
                <span>2</span>
                <p class="no-work__text">
                    Бизнес, который получает прямые или косвенные дотации, субсидии от государства
                </p>
            </div>
            ...
            <div class="no-work__col">
                <span>3</span>
                <p class="no-work__text">
                    Мошеннические, черные схемы по выводу активов, компании, созданные с целью обмана других контрагентов, банков, лизинговых компаний
                </p>
            </div>
            ...
            <div class="no-work__col">
                <span>4</span>
                <p class="no-work__text">
                    Компании, в будущем планирующие возмещение налогов из бюджета
                </p>
            </div>
        </div>
    </div>
...
<!-- trust -->
<section class="trust">
    <div class="container trust__container _anim-item">
        <div class="trust__leftside">
            <h2 class="trust__title title">Почему нам доверяют?</h2>
            <p class="trust__text">
                Консалтинговое бюро «Профи»- это сообщество профессиональных бухгалтеров, юристов и финансовых специалистов
            </p>
            <div class="trust__img">
                <picture>
                    <source class="lazy" data-srcset="<?php echo get_template_directory_uri(); ?>/img/trust/trust_01.webp" type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                    <img data-src="<?php echo get_template_directory_uri(); ?>/img/trust/trust_01.jpg" class="lazy" alt="рукопожатие" src="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                </picture>
            </div>
        </div>
        <div class="trust__rightside">
            <ul class="trust__list">
                <li>- Знаем «российские» реалии работы</li>
                <li>- 100% конфиденциально</li>
                <li>- 100% законно</li>
                <li>- Предоставим любые гарантии по Вашему запросу</li>
                <li>- Оплата любым удобным вам способом (На р/с, перевод, BTC, PayPal и пр.)</li>
            </ul>
        </div>
    </div>
</section>
...
<section class="guarantee">
    <div class="container guarantee__container _anim-item">
        <h2 class="guarantee__title title">Ваши гарантии:</h2>
        <div class="guarantee__row">
            <div class="guarantee__col">
                <div class="guarantee__img">
                    <picture>
                        <source class="lazy" data-srcset="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_01.webp" type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                        <img data-src="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_01.jpg" class="lazy" alt="ФНС" src="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                    </picture>
                </div>
                <p class="guarantee__text">
                    Оплата только после подтверждения из ФНС
                </p>
            </div>
            ...
            <div class="guarantee__col">
                <div class="guarantee__img">
                    <picture>
                        <source class="lazy" data-srcset="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_02.webp" type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                        <img data-src="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_02.jpg" class="lazy" alt="Передача документа" src="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                    </picture>
                </div>
                <p class="guarantee__text">
                    Прохождение сверок, ответ на требования
                </p>
            </div>
            ...
            <div class="guarantee__col">
                <div class="guarantee__img">
                    <picture>
                        <source class="lazy" data-srcset="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_03.webp" type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                        <img data-src="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_03.jpg" class="lazy" alt="Подпись документа" src="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                    </picture>
                </div>
                <p class="guarantee__text">
                    Подпишем Ваш комплект документов без лишних вопросов
                </p>
            </div>
            ...
            <div class="guarantee__col">
                <div class="guarantee__img">
                    <picture>
                        <source class="lazy" data-srcset="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_04.webp" type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                        <img data-src="<?php echo get_template_directory_uri(); ?>/img/guarantee/guarantee_04.jpg" class="lazy" alt="Печать на документе" src="<?php echo get_template_directory_uri(); ?>/img/icons/loading.gif">
                    </picture>
                </div>
                <p class="guarantee__text">
                    Гарантия на замену от 1 года и более
                </p>
            </div>
        </div>
    </div>
...
<section class="request">
    <div class="container request__container _anim-item">
        <h2 class="request__title title">Оставьте заявку нашему специалисту прямо сейчас</h2>
